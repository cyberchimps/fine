...
function cyberchimps_display_about() {
	...
	<div class="about-container">
		...
		<div class="about-info">
			<h1><?php echo "Fine - ".$theme['Version'] ?></h1>
			<?php
				$directory_uri = get_template_directory_uri();

			?>
			<span><img src="<?php echo $directory_uri ?>/images/logo.png"></span>
			<?php printf( '<p>Fine Free is a Responsive WordPress theme offering a fun easy to use Drag & Drop system that adds amazing new functionality to your WordPress website. Featuring responsive touch friendly theme options that work on any device, fully SEO optimized, dynamic sidebar layouts, and per-page dynamic templates.'
			); ?>
		</div>
		...
		<div class="buy">
		<a class="button button-primary buylink" target="_blank" href="https://cyberchimps.com/store/fine-pro/?utm_source=about">Buy Fine Pro</a>
		</div>
	</div>
<?php
}
